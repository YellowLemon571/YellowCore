...
public class ResizerGrow extends Item {

    // Initialize the item with default properties
    public ResizerGrow(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull TooltipContext context, @Nonnull List<Component> tooltipComponents, @Nonnull TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("tooltip.yellowcore.growth_salve").withColor(0xAAAAAA));
    }
